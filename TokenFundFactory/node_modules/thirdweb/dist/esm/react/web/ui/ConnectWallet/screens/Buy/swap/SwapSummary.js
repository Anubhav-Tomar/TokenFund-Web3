...
export function SwapSummary(props) {
    ...
    return (_jsxs(Container, { children: [_jsxs(Container, { bg: "tertiaryBg", flex: "column", style: {
                    ...
                    border: `1px solid ${theme.colors.borderColor}`,
                            ...
                            borderRadius: 0,
                            border: "none",
                        } })] }), _jsx(Container, { flex: "row", center: "both", py: "xxs", children: _jsxs(Container, { flex: "column", center: "both", children: [_jsx(ChevronDownIcon, { width: iconSize.md, height: iconSize.md, style: {
                                color: theme.colors.secondaryIconColor,
                            } }), _jsx(ChevronDownIcon, { width: iconSize.md, height: iconSize.md, style: {
                                color: theme.colors.secondaryIconColor,
                                marginTop: "-17px",
                            } })] }) }), _jsxs(Container, { flex: "column", bg: "tertiaryBg", style: {
                    borderRadius: radius.lg,
                    border: `1px solid ${theme.colors.borderColor}`,
                }, children: [isDifferentRecipient && (_jsx(Container, { flex: "row", gap: "sm", p: "sm", style: {
                            borderBottom: `1px solid ${theme.colors.borderColor}`,
