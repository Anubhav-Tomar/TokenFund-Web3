            ...
            minHeight: "200px",
                    ...
                    maxHeight: "350px",
                            ...
                            return (_jsx(WalletRowWithBalances, { wallet: wallet, balances: balances, client: props.client, address: address, onClick: props.onSelectToken }, w.id));
                                ...
                                padding: spacing.sm,
                            }, children: _jsxs(Container, { flex: "row", gap: "sm", center: "y", expand: true, color: "secondaryIconColor", children: [_jsx(OutlineWalletIcon, { size: iconSize.md }), _jsx(Text, { size: "sm", color: "primaryText", children: "Pay with another wallet" })] }) }), _jsx(Button, { variant: "secondary", fullWidth: true, onClick: props.onPayWithFiat, bg: "tertiaryBg", style: {
                                border: `1px solid ${theme.colors.borderColor}`,
                                padding: spacing.sm,
...
function TokenBalanceRow(props) {
    ...
    return (_jsxs(StyledButton, { onClick: () => onClick(tokenBalance.token, wallet), variant: "secondary", style: style, children: [_jsxs(Container, { flex: "row", center: "y", gap: "sm", children: [_jsx(TokenIcon, { token: tokenBalance.token, chain: tokenBalance.chain, size: "md", client: client }), _jsxs(Container, { flex: "column", gap: "4xs", children: [_jsx(Text, { size: "xs", color: "primaryText", children: tokenBalance.token.symbol }), chainInfo && _jsx(Text, { size: "xs", children: chainInfo.name })] })] }), _jsxs(Container, { flex: "row", center: "y", gap: "4xs", color: "secondaryText", children: [_jsxs(Container, { flex: "column", color: "secondaryText", gap: "4xs", style: {
