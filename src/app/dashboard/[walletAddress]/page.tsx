...
import { TOKENFUND_FACTORY } from "@/app/constants/contracts";
...
export default function DashboardPage() {
    ...
    // Get Campaigns
    const { data: myCampaigns, isPending: isPendingMyCampaigns, refetch } = useReadContract({
        contract: contract,
    ...
    const handleDeployContract = async () => {
        ...
        try {
            ...
            const contractAddress = await deployPublishedContract({
                ...
                publisher: "0x95fDaEd7606119cb734121Cc3BA278E7466Ef37E",
                version: "1.0.0",
            });
