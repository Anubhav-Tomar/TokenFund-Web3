...
function SelectedTokenInfo(props) {
    const getWidth = () => {
        const amount = (0, formatNumber_js_1.formatNumber)(Number(props.tokenAmount), 5).toString();
    ...
    return ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "sm", center: "y", style: {
            ...
            }, children: [(0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "xxs", center: "y", children: [(0, jsx_runtime_1.jsx)(formElements_js_1.Input, { variant: "outline", pattern: "^[0-9]*[.,]?[0-9]*$", inputMode: "decimal", tabIndex: -1, placeholder: "0", type: "text", "data-placeholder": props.tokenAmount === "", value: props.tokenAmount
                                ? (0, formatNumber_js_1.formatNumber)(Number(props.tokenAmount), 5)
                                : "0", disabled: props.disabled, onClick: (e) => {
